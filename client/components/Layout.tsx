    ...
    <Box display="flex" flexDirection="column" style={{ minHeight: '100vh' }}>
      ...
      <footer style={{ marginTop: 'auto' }}>
        <Typography variant="body1" component="p" className={classes.footer}>
          ...
          এসেছেন, WWW.kormerkhoj.com আমাদের লক্ষ্য আপনাকে সঠিক তথ্য দেওয়া,
          প্রতারণার হাত থেকে সাবধান করা আর আপনাদের লক্ষ্য পূরণ করা | আমাদের
          সতর্কতা আর আপনাদের চেষ্টা, সঙ্গে থাকুন 🙏🙏🙏🙏🙏
        </Typography>
      </footer>
    </Box>
  );
